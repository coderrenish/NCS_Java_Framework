...
// FIELD
    ...
    public static void clickLink_Web(String field_link_name) throws Exception {
        BrowserGlobal.iClickOn(waitFieldToBePresentScrollAndEnabled(patternLoc.link(getPageName(),field_link_name)));
    }


    /**
     * @param field_button_name [Button name to click]
     */
    ...
    public static void clickButton_Web(String field_button_name) throws Exception {
        BrowserGlobal.iClickOn(waitFieldToBePresentScrollAndEnabled(patternLoc.button(getPageName(),field_button_name)));
    }
...
//    Web: Input-Text-With-Placeholder Value:{0} Field:{1}
     ...
     */
//    private static String getLocAndWaitFieldToBePresentScrollAndEnabled(String fieldType, String fieldName, String fieldValue,Boolean ignoreLabel) throws Exception {
